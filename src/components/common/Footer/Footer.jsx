...
const Footer = () => {
  return (
    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-[1280px] px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-base font-medium">
                ...
                <li>
                  <a className="text-[#1F2022] transition hover:text-primary" href="#"> Updates </a>
                </li>
              </ul>
            </div>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-base font-medium">
                ...
                <li>
                  <a className="text-[#1F2022] transition hover:text-primary" href="#"> Careers </a>
                </li>
              </ul>
            </div>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-base">
                ...
                <li>
                  <a className="text-[#1F2022] transition hover:text-primary" href="#"> Report </a>
                </li>
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 Kacchi Bhai</p>
          </div>
        </div>
      </div>
    </footer>
